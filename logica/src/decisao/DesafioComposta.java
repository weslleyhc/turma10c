...
public class DesafioComposta {
	...
	public static void main(String[] args) {
		...
		if (passageiros>7) {
			System.out.println("Veículo Categoria C, pois possuem " + passageiros + " passageiros");
		} else if (passageiros>=4 && passageiros<=7) {
			System.out.println("Veículo Cateforia B, pois possuem " + passageiros + " passageiros");
		}else if (passageiros==2) {
			System.out.println("Veículo Categoria A, pois possuem " + passageiros + " passageiros");
		} else {
