...
public class Exercicio1 {
	...
	public static void main(String[] args) {
		/*
		 * 1º) Crie um programa que pergunte ao usuário o seu nível de escolaridade 
		 * (Médio, Superior ou Pós) enquanto a resposta for válida, 
		 * irá computando os totais dos níveis digitados, 
		...
		if (contamedio == 0 && contasuperior == 0 && contapos ==0) {
			System.out.println("Os votos não foram computados");
